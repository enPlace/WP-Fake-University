...
if ( have_posts() ) {
    while ( have_posts() ) {
      ...
      <div class="page-banner__content container container--narrow">
        ...
        <div class="page-banner__intro">
          <p>Replace me later with dynamic content.</p>
        </div>
      </div>
    </div>
    ...
    <div class="container container--narrow page-section">
        ...
        <p>
          <a class="metabox__blog-home-link" href="<?= get_permalink(wp_get_post_parent_id(get_the_id()))?>">
              <i class="fa fa-home" aria-hidden="true"></i> Back to <?= get_the_title(wp_get_post_parent_id(get_the_id())); ?></a> 
    ...
    <h2 class="page-links__title"><a href="#"><?php the_title()?></a></h2>
        ...
        <?php
          ...
          if ( wp_get_post_parent_id(get_the_id())){?>
            <h2 class="page-links__title"><a  href="<?= get_permalink(wp_get_post_parent_id(get_the_id()))?>"><?= get_the_title(wp_get_post_parent_id(get_the_id()))?></a></h2>
                <ul class="min-list">
                  <?php wp_list_pages([
                      'title_li' => NULL,
